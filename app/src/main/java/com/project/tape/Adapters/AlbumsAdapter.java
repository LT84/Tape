...
public class AlbumsAdapter extends RecyclerView.Adapter<AlbumsAdapter.AlbumViewHolder> {
    ...
    public static List<Album> mAlbums;
    ...
    public void onBindViewHolder(@NonNull AlbumViewHolder holder, int position) {
        holder.tv_album_title.setText(mAlbums.get(position).getAlbumName());
    ...
    private class LoadAlbumArt extends AsyncTask<Long, Void, Bitmap> {
        ...
        public LoadAlbumArt(ImageView icon, Context context) {
            ...
            //This is necessary for properly scaling the bitmap.
            width = icon.getWidth();
        ...
        protected Bitmap doInBackground(Long... params) {
            ...
            try {
                ...
                //Create a scaled down version of the bitmap to be more memory efficient.
